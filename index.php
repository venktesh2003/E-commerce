  ...
  <div class="container-fluid ">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <?php
        // if user is active than register must displayed as myaccount
        //for that check the session is active or not
...
getproducts(); //this will display the items on home page
